...
3. Fill in:
   ...
   - **Description** - optional. If you fill this in, it shows on the
     sponsor's card when someone opens it. Worth writing one line per
     sponsor; without it the card just shows the domain.
...
app/
  ...
  components/
    ...
    SponsorCard.js     - Sponsor tile and its tilting card
lib/
